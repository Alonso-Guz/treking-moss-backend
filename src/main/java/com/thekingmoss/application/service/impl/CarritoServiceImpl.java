...
public class CarritoServiceImpl implements ICarritoService {
    ...
    public void vaciarCarrito(Long usuarioId) {
        ...
        // --BY SHE: Obtener todos los productos del carrito del usuario
        List<Carrito> carritos = carritoRepository.findByUsuarioId(usuarioId);
        // --BY SHE: Eliminar todos los productos encontrados
        if (!carritos.isEmpty()) {
            carritoRepository.deleteAll(carritos);
            // --BY SHE: Forzar el flush para asegurar que se eliminen inmediatamente
